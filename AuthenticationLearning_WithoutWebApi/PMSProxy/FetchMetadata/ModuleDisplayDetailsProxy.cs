...
namespace PMSProxy.FetchMetadata
{
    ...
    {
        public static DataSet FetchModuleDisplayDetails(string TenantId, string RoleId)
        {
            IModuleDisplayDetailsService moduleDisplayDetailsService = new ModuleDisplayDetailsService();
            return moduleDisplayDetailsService.FetchModuleDisplayDetails(TenantId, RoleId);
        }
    }
}
